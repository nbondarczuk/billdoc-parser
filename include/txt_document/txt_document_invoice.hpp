...
public:
	TXTDocumentInvoice(std::map<std::string, BillDocument*>& bd):
		...
		invoice_info(dynamic_cast<XMLDocumentInvoiceInfo*>(bd["Document.InvoiceInfo"])),
		address(dynamic_cast<XMLDocumentAddressPage*>(bd["Document.AddressPage"])),
		balance(dynamic_cast<XMLDocumentBalancePage*>(bd["Document.BalancePage"])),
	...
	virtual std::string id() const {
		return "TXTDocument::TXTDocumentInvoice";
	}
